...
use crate::*;
use crate::constants::{ALICE, BOB, CHARLIE, leafchain_a, leafchain_b};
use xcm_emulator::bx;
...
fn reserve_transfer_between_parachains() {
    ...
    LeafchainA::execute_with(|| {
        ...
        let beneficiary = MultiLocation::new(
            ...
            X1(AccountId32 {
                network: None,
                id: LeafchainB::account_id_of(BOB).into(),
            }),
        );
...
fn bidirectional_xcmp_transfers() {
    ...
    LeafchainB::execute_with(|| {
        ...
        let beneficiary = MultiLocation::new(
            ...
            X1(AccountId32 {
                network: None,
                id: LeafchainA::account_id_of(CHARLIE).into(),
            }),
        );
...
fn xcmp_channel_establishment() {
    ...
    LeafchainA::execute_with(|| {
        ...
        let beneficiary = MultiLocation::new(
            ...
            X1(AccountId32 {
                network: None,
                id: LeafchainB::account_id_of(ALICE).into(),
            }),
        );
        let assets: MultiAssets = (Parent, transfer_amount).into();
